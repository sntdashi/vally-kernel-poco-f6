...
cp https://github.com/sntdashi/vally-kernel-poco-f6/blob/main/boot.img AnyKernel/boot.img
cp https://github.com/sntdashi/vally-kernel-poco-f6/blob/main/vendor_boot.img AnyKernel/vendor_boot.img
cp https://github.com/sntdashi/vally-kernel-poco-f6/blob/main/dtbo.img AnyKernel/dtbo.img
